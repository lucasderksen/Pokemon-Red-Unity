        ...
        if (battleState == BattleState.PlayerTurn && Dialogue.instance.finishedText)
        {
            ...
            if (currentmenu == battlemenu)
            {
                ...
                if (Inputs.pressed("left"))
                {
                    ...
                    if (selectedOption == (int)BattleOption.Pokemon)
                    {
                        selectedOption = (int)BattleOption.Fight;
                        return;
                    }

                    if (selectedOption == (int)BattleOption.Run)
                    {
                        selectedOption = (int)BattleOption.Item;
                        return;
                    }
                }
                if (Inputs.pressed("right"))
                {
                    ...
                    {
                        selectedOption = (int)BattleOption.Pokemon;
                        return;
                    }

                    if (selectedOption == (int)BattleOption.Item)
                    {
                        selectedOption = (int)BattleOption.Run;
                        return;
                    }
                }
